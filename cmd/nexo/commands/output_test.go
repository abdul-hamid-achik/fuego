...
func TestInfoOutput_JSON(t *testing.T) {
	output := InfoOutput{
		...
		HasConfig:  true,
		ConfigPath: "/path/to/project/nexo.yaml",
		Routes: []RouteOutput{
...
func TestUpgradeOutput_JSON(t *testing.T) {
	output := UpgradeOutput{
		...
		BackupPath:      "/home/user/.cache/nexo/nexo.backup",
	}
...
func TestDeployOutput_JSON(t *testing.T) {
	output := DeployOutput{
		...
		Status:       "deployed",
		URL:          "https://myapp.nexo.build",
		Image:        "registry.nexo.build/myapp:v1.2.3",
...
func TestDomainsListOutput_JSON(t *testing.T) {
	output := DomainsListOutput{
		...
		Domains: []DomainOutput{
			...
			{Name: "www.example.com", Status: "pending", Verified: false, SSL: false, DNSRecord: "CNAME myapp.nexo.build"},
		},
	}
...
func TestDomainAddOutput_JSON(t *testing.T) {
	output := DomainAddOutput{
		...
		DNSRecord: "CNAME myapp.nexo.build",
