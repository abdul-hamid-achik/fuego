...
//
// Note: Nexo now includes an app-level logger that captures ALL requests,
...
//	app.SetLogger(nexo.RequestLoggerConfig{...}) // Customize
...
//	app.Use(nexo.Logger()) // Use middleware logger
