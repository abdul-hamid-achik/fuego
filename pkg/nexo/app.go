...
// App is the main Nexo application.
type App struct {
...
// New creates a new Nexo application with the given options.
...
func (a *App) Listen(addr ...string) error {
	...
	go func() {
		fmt.Printf("\n  Nexo running at http://localhost%s\n\n", address)
...
// Example:
//
//	app.SetProxy(func(c *nexo.Context) (*nexo.ProxyResult, error) {
//	    if strings.HasPrefix(c.Path(), "/old/") {
//	        return nexo.Redirect("/new/"+strings.TrimPrefix(c.Path(), "/old/"), 301), nil
//	    }
