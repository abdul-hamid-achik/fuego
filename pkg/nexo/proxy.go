...
//	    if c.Path() == "/old-page" {
//	        return nexo.Redirect("/new-page", 301), nil
//	    }
//	    return nexo.Continue(), nil
//	}
...
//	        return nexo.Rewrite("/variant-b" + c.Path()), nil
//	    }
//	    return nexo.Continue(), nil
//	}
...
//	        return nexo.Response(403, []byte(`{"error":"forbidden"}`), "application/json"), nil
//	    }
//	    return nexo.Continue(), nil
//	}
...
//	        return nexo.ResponseJSON(401, `{"error":"unauthorized"}`), nil
//	    }
//	    return nexo.Continue(), nil
//	}
...
// Example:
//
//	return nexo.Redirect("/login", 302).WithHeader("X-Reason", "session-expired"), nil
