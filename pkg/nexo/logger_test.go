...
func TestDefaultRequestLoggerConfig(t *testing.T) {
	...
	origLevel := os.Getenv("NEXO_LOG_LEVEL")
	origDev := os.Getenv("NEXO_DEV")
	origEnv := os.Getenv("GO_ENV")
	defer func() {
		_ = os.Setenv("NEXO_LOG_LEVEL", origLevel)
		_ = os.Setenv("NEXO_DEV", origDev)
		_ = os.Setenv("GO_ENV", origEnv)
	}()

	t.Run("default config", func(t *testing.T) {
		_ = os.Unsetenv("NEXO_LOG_LEVEL")
		_ = os.Unsetenv("NEXO_DEV")
	...
	t.Run("NEXO_LOG_LEVEL overrides", func(t *testing.T) {
		_ = os.Setenv("NEXO_LOG_LEVEL", "error")
		_ = os.Setenv("NEXO_DEV", "true") // Should be overridden
