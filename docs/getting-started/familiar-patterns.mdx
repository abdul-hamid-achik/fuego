...
<Info>
Nexo uses the same Next.js App Router naming conventions for routing patterns. If you know Next.js, you already know Nexo!
</Info>
...
The structure is nearly identical - just swap the file extensions from TypeScript/Svelte to Go/templ.
