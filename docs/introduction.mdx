...
<img
  ...
  alt="Nexo - File-based routing for Go"
/>
<img
...
Nexo is a file-based routing framework for Go, inspired by Next.js App Router. Your file structure *is* your router - no manual route registration required.
...
Nexo includes a built-in request logger that captures ALL requests:
...
If you've used Next.js, Nuxt, SvelteKit, or similar frameworks, Nexo's patterns will feel familiar:
...
<Card title="Familiar Patterns Guide" icon="book" href="/docs/getting-started/familiar-patterns">
  Learn how Nexo compares to frameworks you already know
</Card>
