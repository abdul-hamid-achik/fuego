...
description: 'Secure your Nexo applications with JWT tokens, sessions, API keys, and middleware-based auth patterns.'
---

Authentication is a critical component of any web application. Nexo provides flexible patterns for implementing authentication using middleware, the proxy layer, and the Context API.
...
func SessionMiddleware() nexo.MiddlewareFunc {
    return func(next nexo.HandlerFunc) nexo.HandlerFunc {
        return func(c *nexo.Context) error {
...
func APIKeyMiddleware() nexo.MiddlewareFunc {
    return func(next nexo.HandlerFunc) nexo.HandlerFunc {
        return func(c *nexo.Context) error {
...
func RequireRole(roles ...Role) nexo.MiddlewareFunc {
    return func(next nexo.HandlerFunc) nexo.HandlerFunc {
        return func(c *nexo.Context) error {
...
func RequireAdmin() nexo.MiddlewareFunc {
