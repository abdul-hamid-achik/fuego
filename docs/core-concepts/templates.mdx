...
Dynamic pages use bracket-style directory names to capture URL parameters.
...
Nexo matches URL parameters to `Page()` parameters **by name**. Your parameter names should match the directory names (without the brackets):
