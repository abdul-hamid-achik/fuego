...
<Tabs>
  ...
  <Tab title="Unauthorized">
    ...
    func Get(c *fuego.Context) error {
        ...
        if err != nil {
            return fuego.Unauthorized("invalid or expired token")
        }
  ...
  <Tab title="Forbidden">
    ...
    func Delete(c *fuego.Context) error {
        ...
        if user.ID != resourceOwnerID && !user.IsAdmin {
            return fuego.Forbidden("you don't have permission to delete this resource")
        }
  ...
  <Tab title="NotFound">
    ...
    func Get(c *fuego.Context) error {
        ...
        if err != nil {
            return fuego.InternalServerError("database error")
        }
  ...
  <Tab title="Conflict">
    ...
    func Post(c *fuego.Context) error {
        ...
        if existing != nil {
            return fuego.Conflict("user with this email already exists")
        }
  ...
  <Tab title="InternalServerError">
    ...
    func Get(c *fuego.Context) error {
        ...
        if err != nil {
            ...
            return fuego.InternalServerError("service temporarily unavailable")
        }
