...
- [Middleware](../middleware/overview.md) — Processing requests
- [File-based Routing](../routing/file-based.md) — Route patterns
- [Proxy](../middleware/proxy.md) — Request interception
