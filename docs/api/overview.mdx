---
title: API Reference
description: 'Complete API documentation for the Nexo framework'
---

The Nexo framework provides a clean, intuitive API for building web applications and APIs in Go. This reference documents all public types, functions, and methods.
...
| Method | Description |
|--------|-------------|
| `nexo.New(opts...)` | Create a new App with optional configuration |
...
func main() {
    ...
    app.Get("/", func(c *nexo.Context) error {
...
<Info>
For Go documentation with full type details, see the [pkg.go.dev documentation](https://pkg.go.dev/github.com/abdul-hamid-achik/nexo/pkg/nexo).
</Info>
