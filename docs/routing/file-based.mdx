...
<Warning>
Fuego automatically creates symlinks for `[bracket]` directories to enable valid Go imports (e.g., `_id` → `[id]`). These symlinks are managed automatically and should not be committed to version control.
</Warning>
